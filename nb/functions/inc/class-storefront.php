...
if ( ! class_exists( 'Storefront' ) ) :
	...
	class Storefront {
			...
			register_nav_menus(
				apply_filters(
					'storefront_register_nav_menus', array(
						...
						'categories'		=> __( 'Categories Menu', 'storefront' ),
						'countries'			=> __( 'Countries Menu', 'storefront' ),
						'footer'   			=> __( 'Footer Menu', 'storefront' ),
						'footercategories'	=> __( 'Footer Categories Menu', 'storefront' ),
						'checkout'			=> __( 'Checkout Menu', 'storefront' ),
						'emptycart'			=> __( 'Empty Cart', 'storefront' ),
					)
				)
			);
		...
		public function scripts() {
			...
			// wp_enqueue_style( 'app', get_template_directory_uri() . '/assets/css/app.css', '', $storefront_version );
			// wp_enqueue_style( 'custom', get_template_directory_uri() . '/assets/css/custom.css', '', $storefront_version );
			...
			// wp_enqueue_script( 'webfontloader', get_template_directory_uri() . '/assets/js/vendor/webfontloader-1.6.26.js', array(), '1.6.26', true );
			
			// wp_enqueue_script( 'bundle', get_template_directory_uri() . '/assets/js/bundle.js', array('jquery'), '1', true );
			// wp_enqueue_script( 'jquery-pep', get_template_directory_uri() . '/assets/js/vendor/pep.min.js', array(), '0.4.3', true );			
			// wp_enqueue_script( 'axios', get_template_directory_uri() . '/assets/js/vendor/axios.min.js', array(), '0.18.0', true );
			// wp_enqueue_script( 'vue', get_template_directory_uri() . '/assets/js/vendor/vue.min.js', array(), '2.6.10', true );			
			
			// Vue Editor
			//wp_enqueue_script( 'vueeditor', get_template_directory_uri() . '/assets/js/vueeditor/vueeditor.js', array(), '1', true );	
			...
			wp_localize_script('app', 'ajax', array(
				...
				//'generator_url' => get_template_directory_uri().'/gen/generator.php'
			));

			// Ajax VUEeditor
/*
			wp_localize_script('vueeditor', 'ajax', array(
				'ajaxurl' => admin_url('admin-ajax.php'),
				'sxnonce' => wp_create_nonce('sx-generic-nonce'),
			));
